...
<div class="space-y-4">
		...
		<CardBody>
			...
			<div class="space-y-4">
				{#each colors as color}
					<TextInput {color} placeholder={color.charAt(0).toUpperCase() + color.slice(1)} />
				{/each}
			</div>
		</CardBody>
	</Card>
	...
	<Card>
		<CardBody>
			...
			<div class="space-y-4">
				{#each sizes as size}
					<TextInput {size} placeholder={`Size: ${size}`} />
				{/each}
			</div>
		</CardBody>
	</Card>
	...
	<Card>
		<CardBody>
			...
			<div class="space-y-4">
				...
				<SearchInput placeholder="Search with shortcut..." showShortcut />
			</div>
		</CardBody>
	</Card>
	...
	<Card>
		<CardBody>
			...
			<div class="space-y-4">
				...
				<NumberInput placeholder="With range (1-10)" min={1} max={10} />
				<NumberInput placeholder="With step (0.5)" step={0.5} />
				<NumberInput color="primary" placeholder="Styled number input" min={0} required />
			</div>
		</CardBody>
	</Card>
	...
	<Card>
		<CardBody>
			...
			<div class="space-y-4">
				<DateTimeInput type="date" placeholder="Select date" />
				<DateTimeInput type="time" placeholder="Select time" />
				<DateTimeInput type="datetime-local" placeholder="Select date and time" />
				<DateTimeInput type="month" placeholder="Select month" />
				<DateTimeInput type="week" placeholder="Select week" />
				<DateTimeInput
					type="date"
					color="primary"
					min="2024-01-01"
